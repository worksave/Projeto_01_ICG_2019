...
void InitOpenGL(int *argc, char **argv)
{
	...
	glutInitWindowPosition(CENTER_SCREEN_WIDTH, CENTER_SCREEN_HEIGHT);
	glutCreateWindow("ICG - Trabalho I - Magno e Emmanuella");
...
void InitDataStructures(void)
{
	...
	for (unsigned int i = 0; i < IMAGE_WIDTH * IMAGE_HEIGHT ; i+=4)
	{
		FBptr[i*4]   = 0;
		FBptr[i*4+1] = 0;
		FBptr[i*4+2] = 0;
